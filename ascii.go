...
var asciiRuneMap = map[rune]string{
	...
	// Combining overlays (\not, \cancel, \sout) vanish in ASCII.
	'̸': "", '̶': "", '̄': "", '̆': "", '̌': "",
	'́': "", '̀': "", '̊': "", '⃛': "",

	// Greek variants
	'ϑ': "theta", 'ϖ': "pi", 'ϱ': "rho", 'ς': "sigma", 'ϰ': "kappa", 'ϝ': "digamma",
	'ϵ': "epsilon", 'ϕ': "phi", 'ϴ': "Theta",

	// Letterlike and misc
	'ℵ': "aleph", 'ℶ': "beth", 'ℷ': "gimel", 'ℸ': "daleth", 'ℜ': "Re", 'ℑ': "Im",
	'℘': "P", 'ı': "i", 'ȷ': "j", '℧': "mho", 'ð': "eth", 'Ⅎ': "F", '⅁': "G",
	'∁': "C", '∠': "angle", '∡': "angle", '∢': "angle", '△': "/\\", '▽': "\\/",
	'□': "[]", '■': "[#]", '◇': "<>", '◊': "<>", '⧫': "<#>", '★': "*",
	...
	'≺': "<", '≻': ">", '⪯': "<=", '⪰': ">=", '⊀': "!<", '⊁': "!>",
	'≾': "<~", '≿': ">~", '⊊': "sub!=", '⊋': "sup!=", '⊈': "!sube",
	'⊉': "!supe", '⊄': "!sub", '⊅': "!sup", '⋐': "Sub", '⋑': "Sup",
	'⊏': "sqsub", '⊐': "sqsup", '⊑': "sqsube", '⊒': "sqsupe",
	'∋': "ni", '∌': "!ni", '≮': "!<", '≯': "!>", '≰': "!<=", '≱': "!>=",
	'≦': "<=", '≧': ">=", '⩽': "<=", '⩾': ">=", '≲': "<~", '≳': ">~",
	'≶': "<>", '≷': "><", '⪅': "<~", '⪆': ">~", '⋚': "<=>", '⋛': ">=<",
	...
	// Big operators
	'∐': "Coprod", '∬': "iint", '∭': "iiint", '∯': "oiint", '∰': "oiiint",
	'⋃': "Union", '⋂': "Inter", '⨁': "(+)", '⨂': "(x)", '⋁': "Or", '⋀': "And",
	'⨆': "Sqcup",
}
...
func asciify(s string) string {
	...
	for _, r := range s {
		...
		if g := mathGreekToPlain(r); g != 0 {
			r = g // styled Greek → plain Greek → spelled-out name below
		}
